...
class GuestMixin(object):
    ...
    def _check_if_guest_is_active(self, datastore_manager):
...
class FreshInstanceTaskMixin(FreshInstance, NotifyMixin,
                             ConfigurationMixin, LogAndRizeMixin,
                             GuestMixin):
    ...
    def do_guest_check(self, datastore_manager, flavor, server=None):
        ...
        try:
            self._check_if_guest_is_active(datastore_manager)
...
class BuiltInstanceTasksMixin(BuiltInstance, NotifyMixin,
                              ConfigurationMixin, LogAndRizeMixin,
                              GuestMixin):
