...
class ClusterTasks(object):
    ...
    ADDING_DATA_NODE = ClusterTask(
        0x05, 'ADDING_DATA_NODE', 'Adding a data node to the cluster.')
    ADDING_SEED_NODE = ClusterTask(
        0x06, 'ADDING_SEED_NODE', 'Adding a seed node to the cluster.')
