...
from guestagent.agent.datastore import service
from guestagent.common import cfg
from guestagent.common import utils as utils
from guestagent.common import exception
from guestagent.common import operating_system
from guestagent.common import sql_query
...
class MySqlRootAccess(object):
    ...
    def report_root_enabled(cls, context):
        conductor_api.API(context).report_user_created(CONF.guest_id, 'root')
