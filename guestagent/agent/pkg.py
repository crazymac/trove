...
class PkgAdminLockError(exception.GuestagentError):
    pass


class PkgPermissionError(exception.GuestagentError):
    pass


class PkgPackageStateError(exception.GuestagentError):
    pass
...
class PkgTimeout(exception.GuestagentError):
    pass


class PkgScriptletError(exception.GuestagentError):
    pass


class PkgDownloadError(exception.GuestagentError):
    pass


class PkgSignError(exception.GuestagentError):
    pass


class PkgBrokenError(exception.GuestagentError):
    pass
