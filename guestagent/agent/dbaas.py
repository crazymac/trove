...
from guestagent.openstack.common import log
from itertools import chain


LOG = log.getLogger(__name__)
defaults = {
    'mysql': 'guestagent.agent.datastore.mysql.manager.Manager',
    'percona': 'guestagent.agent.datastore.mysql.manager.Manager',
}
