...
import guestagent.agent.datastore.mysql.service as dbaas
from guestagent.common import utils, operating_system
from guestagent.trove.state import instance as rd_instance
from guestagent.trove import conductor_api
from guestagent.agent import dbaas as dbaas_sr
from guestagent.agent import pkg
from guestagent.agent.dbaas import to_gb
from guestagent.agent.dbaas import get_filesystem_volume_stats
from guestagent.agent.datastore.service import BaseDbStatus
from guestagent.agent.datastore.mysql.service import MySqlAdmin
from guestagent.agent.datastore.mysql.service import MySqlRootAccess
from guestagent.agent.datastore.mysql.service import MySqlApp
from guestagent.agent.datastore.mysql.service import MySqlAppStatus
from guestagent.agent.datastore.mysql.service import KeepAliveConnection
from guestagent.agent.db import models
from guestagent.trove.state.instance import InstanceServiceStatus
from guestagent.tests.unittests.util import util
...
class DbaasTest(testtools.TestCase):
    ...
    def test_load_mysqld_options_error(self):
        ...
        from guestagent.common.exception import ProcessExecutionError
...
class ServiceRegistryTest(testtools.TestCase):
    ...
    def setUp(self):
        ...
        self.percona_real_mngr = self.mysql_real_mngr = (
            'guestagent.agent.datastore.mysql.manager.Manager')
    ...
    def test_datastore_registry_with_extra_manager(self):
        ...
        self.assertEqual(test_dict.get('mysql'),
                         self.mysql_real_mngr)
        self.assertEqual(test_dict.get('percona'),
                         self.percona_real_mngr)
    ...
    def test_datastore_registry_with_existing_manager(self):
        ...
        self.assertNotEqual(test_dict.get('mysql'),
                            self.mysql_real_mngr)
        self.assertEqual(test_dict.get('percona'),
                         self.percona_real_mngr)
