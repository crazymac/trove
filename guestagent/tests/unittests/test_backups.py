...
import guestagent.agent.strategies.backup.base as backupBase
import guestagent.agent.strategies.restore.base as restoreBase

from guestagent.common import utils

BACKUP_XTRA_CLS = ("guestagent.agent.strategies.backup."
                   "impl.InnoBackupEx")
RESTORE_XTRA_CLS = ("guestagent.agent.strategies.restore."
                    "impl.InnoBackupEx")
BACKUP_SQLDUMP_CLS = ("guestagent.agent.strategies.backup."
                      "impl.MySQLDump")
RESTORE_SQLDUMP_CLS = ("guestagent.agent.strategies.restore."
                       "impl.MySQLDump")
PIPE = " | "
ZIP = "gzip"
UNZIP = "gzip -d -c"
